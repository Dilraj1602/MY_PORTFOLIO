    ...
    return (
        <div className="flex space-x-16 pt-6 sm:pt-12 md:pt-24 translate-y-12 w-full">
            ...
            <div className=" flex flex-col md:flex-row-reverse md:justify-between md:items-center md:w-[77%]">
                ...
                <div className=" w-[250px] h-[250px] tilt-effect_1 ">
                    <svg
                        ...
                        <g>
                            ...
                            <path
                                d="M190.312 36.4879C206.582 62.1187 201.309 102.826 182.328 134.186C163.346 
                                        ...
                                        129.362C2.45775 97.8511 -7.48481 59.1033 6.67581 34.5279C20.9871 10.1032 59.7028 
                                        -0.149132 97.9666 0.00163737C136.23 0.303176 174.193 10.857 190.312 36.4879Z"
                                fill="var(--first-color)" // Apply the background color here
                            />
                ...
                <div className="flex flex-col items-start space-y-6 pl-[7%]">
                    <h1 className="text-5xl font-semibold text-[var(--title-color)]">
                        Hi, I'm Dil Raj
                    </h1>
                    <h2 className="text-2xl text-gray-700 text-[var(--text-color)] font-[500]">
                        I am a <span className="role text-[var(--text-color)] font-[500]"></span>
                    </h2>
                    <p className="text-lg text-[var(--text-color-light)] w-[80%]">
                        Building software to solve real-life problems.
                    </p>
                    <Button text="Contact Me" icon="uil uil-message" onClick={() => handleScroll_1("contact")} />
                </div>
            </div>
        </div>
    );
