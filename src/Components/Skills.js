...
function Skills() {
  ...
  return (
    <div className="md:pt-[5.5rem] flex flex-col relative justify-center items-center   ">
      <h1 className="text-[2rem] font-bold text-[var(--body-font)] font-Poppins">Skills</h1>
      <p className="text-[1.1rem] text-gray-500 mb-10 ">My Technical Skills</p>
      ...
      <div className="grid grid-cols-1 gap-[40px] md:grid-cols-2 md:gap-[80px] mt-8 pl-[1%] md:pl-[7%] ">
        ...
        <div className="relative">
          ...
          <p
            className="flex items-center hover:cursor-pointer text-gray-400 select-none "
            onClick={() => setIsDown2(!isdown2)} // Toggle on click
          >
